    ...
    <div>
      <main class="flex flex-col flex-1 md:p-0 lg:pt-8 lg:px-8 md:ml-24">
        <section class="p-4 shadow bg-cream-lighter">
          <div class="md:flex">
            <h2 class="mb-6 text-sm tracking-wide uppercase md:w-1/3 sm:text-lg">Upload New Episode</h2>
          </div>
          <form @submit.prevent="store" enctype="multipart/form-data" id="newEpisode" name="newEpisode">
            <!-- Episode Title -->
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Episode Title</legend>
                <p class="text-xs font-light text-red">Title of the episode.</p>
              </div>

              <div class="mt-2 md:flex-1 mb:mt-0 md:px-3">
                <div class="mb-4">
                  <input class="w-full p-4 border-0 shadow-inner" type="text" id="title" v-model="form.title" :error="form.errors.title" placeholder="Death Star Chapter - Episode 1 - The Screams Of The Damned" />
                </div>
              </div>
            </div>
            ...
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Episode Short Description</legend>
                <p class="text-xs font-light text-red">Short description used for the episode lists.</p>
              </div>

              <div class="mt-2 md:flex-1 mb:mt-0 md:px-3">
                <div class="mb-4">
                  <input class="w-full p-4 border-0 shadow-inner" type="text" id="short_description" v-model="form.short_description" :error="form.errors.short_description" placeholder="Each hall echos with the screms of those lost souls." />
                </div>
              </div>
            </div>
            ...
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Episode Long Description</legend>
                <p class="text-xs font-light text-red">Full description of the episode.</p>
              </div>

              <div class="mt-2 md:flex-1 mb:mt-0 md:px-3">
                <div class="mb-4">
                  <input class="w-full p-4 border-0 shadow-inner" type="text" id="long_description" v-model="form.long_description" :error="form.errors.long_description" placeholder="Each hall echos with the screms of those lost souls. Their lives stolen from them in the blind of an eye by a rouge band of freedom fighters/ terrorists." />
                </div>
              </div>
            </div>
            ...
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Chapter</legend>
                <p class="text-xs font-light text-red">The Chapter this episode belongs to.</p>
              </div>
            ...
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Explicit Warning</legend>
                <p class="text-xs font-light text-red">A Toggle button to alert listeners that this episode has explicit content.</p>
              </div>
            ...
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Author</legend>
                <p class="text-xs font-light text-red">The Author of the episode.</p>
              </div>
            ...
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Author Email</legend>
                <p class="text-xs font-light text-red">The contact email of the author.</p>
              </div>

              <div class="mt-2 md:flex-1 mb:mt-0 md:px-3">
                <div class="mb-4">
                  <input class="w-full p-4 border-0 shadow-inner" type="text" id="name" v-model="form.author_email" :error="form.errors.author_email" placeholder="darth_vader@thedeath.star" />
                </div>
              </div>
            </div>
            ...
            <div class="mb-6 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Episode File</legend>
              </div>
              <div class="px-3 text-center md:flex-1">
                <div class="relative mx-auto button bg-gold hover:bg-gold-dark text-cream cusor-pointer">
                  <input @change="selectFile" id="episode" type="file" class="w-full pb-8 pr-6 lg:w-1/2" />
                  Upload Episode File
                </div>
              </div>
            </div>
            ...
            <div class="mb-6 border border-b-0 md:flex border-t-1 border-x-0 border-cream-dark">
              <div class="px-3 text-center md:flex-1 md:text-right">
                ...
                <input class="button text-cream-lighter bg-brick hover:bg-brick-dark" type="submit" value="Upload Episode" />
              </div>
            </div>
          </form>
        </section>
...
export default {
  components: { AppLayout, FileInput, Checkbox },
  remember: "form",
  ...
  methods: {
    ...
    store() {
      this.form.post(this.route("episode-store"), {
        onSuccess: () => {
...
.hover\:shadow-light:hover {
  text-shadow: 1px 1px 0 rgba(244, 244, 240, 1), 2px 2px 0 rgba(81, 76, 77, 0.3);
}
