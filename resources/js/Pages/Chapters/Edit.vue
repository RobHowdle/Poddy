    ...
    <div>
      <main class="flex flex-col flex-1 md:p-0 lg:pt-8 lg:px-8 md:ml-24">
        <section class="p-4 shadow bg-cream-lighter">
          <div class="md:flex">
            <h2 class="mb-6 text-sm tracking-wide uppercase md:w-1/3 sm:text-lg">Edit Chapter</h2>
          </div>
          <form @submit.prevent="update" enctype="multipart/form-data">
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Chapter Name</legend>
                <p class="text-xs font-light text-red">This should be unique to the location of the host.</p>
              </div>
            ...
            <div class="mb-8 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Chapter Host</legend>
                <p class="text-xs font-light text-red">The host of this chapter.</p>
              </div>
              <div class="mt-2 md:flex-1 mb:mt-0 md:px-3">
                <div class="mb-4">
            ...
            <div class="mb-6 md:flex">
              <div class="md:w-1/3">
                <legend class="text-sm tracking-wide uppercase">Description</legend>
            ...
            <div class="mb-6 border border-b-0 md:flex border-t-1 border-x-0 border-cream-dark">
              <div class="px-3 text-center md:flex-1 md:text-right">
                ...
                <input class="button text-cream-lighter bg-brick hover:bg-brick-dark" type="submit" value="Create Chapter" />
              </div>
            </div>
          </form>
        </section>
  ...
  data() {
    return {
      form: this.$inertia.form({
        ...
        userId: this.chapter.userId,
        description: this.chapter.description,
        logo: this.chapter.logo,
        thinLogo: this.chapter.thinLogo,
      }),
    }
  },
  methods: {
    ...
    update() {
      this.form.post(this.route("chapter-update", this.chapter.id), {
        onSuccess: () => this.form.reset("logo", "thinLogo"),
      })
    },
  },
}
